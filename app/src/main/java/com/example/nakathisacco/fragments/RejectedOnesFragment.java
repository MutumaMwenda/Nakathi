...
public class RejectedOnesFragment extends Fragment {
    ...
    private void getGuarantorLoansR(String id_number) {
        mService.getGuarantorLoansR(id_number).enqueue(new Callback<List<LoanApplicantModel>>() {
            @Override
